...
- **Live at** [tropihug.pages.dev](https://tropihug.pages.dev) (Cloudflare Pages, direct upload of the site files).
- Briefly lived at `adenaufal.com/tropihug` as a subpath of the portfolio site; moved out to its own Pages project to keep the portfolio repo lean. Canonical URL updated accordingly.
